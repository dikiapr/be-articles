...
public static class DbSeeder
{
    public static void Seed(AppDbContext db)
    {
        ...
        {
            Username = "Admin ArtikelKu",
            Email = "admin@artikelku.com",
        ...
        db.Articles.AddRange(
            new Article
            {
                ...
                Content = """
React adalah library JavaScript open-source yang dibuat oleh Meta (sebelumnya Facebook) untuk membangun antarmuka pengguna (UI). Sejak diluncurkan pada 2013, React telah menjadi salah satu pilihan utama para developer web di seluruh dunia.
...
""",
                ...
                CreatedAt = DateTime.Parse("2024-01-15T08:00:00.000Z").ToUniversalTime()
            },
            new Article
            {
                ...
                Content = """
TypeScript adalah superset dari JavaScript yang dikembangkan oleh Microsoft. Artinya, semua kode JavaScript yang valid juga valid di TypeScript — TypeScript hanya menambahkan fitur di atasnya.
...
""",
                AuthorName = "Admin ArtikelKu",
                CreatedAt = DateTime.Parse("2024-02-03T09:30:00.000Z").ToUniversalTime()
            },
            new Article
            {
                ...
                Content = """
localStorage adalah mekanisme penyimpanan yang disediakan oleh browser modern. Data yang disimpan di localStorage akan tetap ada meski tab atau browser ditutup — berbeda dengan sessionStorage yang hilang saat sesi berakhir.
...
""",
                AuthorName = "Admin ArtikelKu",
                CreatedAt = DateTime.Parse("2024-02-20T14:00:00.000Z").ToUniversalTime()
            },
            new Article
            {
                ...
                Content = """
React secara default adalah library untuk membangun UI — bukan untuk mengatur navigasi antar halaman. Di sinilah **React Router** berperan.
...
""",
                AuthorName = "Admin ArtikelKu",
                CreatedAt = DateTime.Parse("2024-03-10T11:00:00.000Z").ToUniversalTime()
            },
            new Article
            {
                ...
                Content = """
Vite (dibaca "vit", dari bahasa Prancis artinya "cepat") adalah build tool modern yang diciptakan oleh Evan You — creator Vue.js. Meski awalnya untuk Vue, Vite kini mendukung React, Svelte, dan framework lainnya.
...
""",
                AuthorName = "Admin ArtikelKu",
                CreatedAt = DateTime.Parse("2024-04-05T10:00:00.000Z").ToUniversalTime()
            });
